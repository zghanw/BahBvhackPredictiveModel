...
**Team Britney and her Bodyguards** present a hackathon-grade deep learning pipeline using **PyTorch** to predict RUL of industrial machinery from multivariate sensor time-series (NASA CMAPSS dataset).
